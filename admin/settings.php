<?php
  ...
  $menuList = ["General Settings"=>"general","Providers"=>"providers","Payments"=>"payment-methods","Bank Accounts"=>"bank-accounts",  "Modules"=>"modules","Support Settings"=>"subject","Bonuses"=>"payment-bonuses","Currency"=>"currency","Notification settings"=>"alert"];
...
$order = explode("/", $url);
            ...
            $insert = $insert->execute(array(  "name"=>$name,"key"=>"$key","url"=>$url,"status"=>1, "limit"=>0,"currency"=>"USD" ,"type"=>1,"api_alert"=>1));
