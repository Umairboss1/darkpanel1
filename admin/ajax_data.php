...
elseif ($action == "edit_paymentmethod" && $_POST["id"] == "Easypaisa") :
  $id = $_POST['id'];
    ...
    $return .= '>Inactive</option>' . "\r\n" . '</select>' . "\r\n" . '  </div>' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Visible name</label>' . "\r\n" . '  <input type="text" class="form-control" name="name" value="' . $extra['name'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Minimum Payment</label>' . "\r\n" . '  <input type="number" class="form-control" name="min" value="' . $extra['min'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Maximum Payment</label>' . "\r\n" . '  <input type="number" class="form-control" name="max" value="' . $extra['max'] . '">' . "\r\n" .  ' <hr>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Easypaisa Account Number</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_number" value="' . $extra['account_number'] . '">' . "\r\n" . ' </div>' . "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Account Title</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_name" value="' . $extra['account_name'] . '">' . "\r\n" . ' </div>' . "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Transaction Fee %</label>' . "\r\n" . '  <input type="text" class="form-control" name="tnx_fee" value="' . $extra['tnx_fee'] . '">' . "\r\n" . ' </div>' .  "\r\n" . 
     '<div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Instructions</label>' . "\r\n" . '  <input type="text" class="form-control" name="instructions" value="' . $extra['instructions'] . '">'
    
    . "\r\n" . ' </div>' .  "\r\n" .
    ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Email (used to fetch transaction details)</label>' . "\r\n" . '  <input type="text" class="form-control" name="gmail" value="' . $extra['gmail'] . '">' . "\r\n" . ' </div>' .
    
    "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Email Password </label>' . "\r\n" . '  <input type="text" class="form-control" name="gmail_password" value="' . $extra['gmail_password'] . '">' . "\r\n" . ' </div>' .
       
        "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">USD Rate in PKR </label>' . "\r\n" . '  <input type="text" class="form-control" name="rate_to_usd" value="' . $extra['rate_to_usd'] . '">' . "\r\n" . ' </div>' .
          "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Mail Server </label><small>Go to the manage devices in email setting. Copy your incoming server and paste it. usually it is mail.yourdomain </small>' . "\r\n" . '  <input type="text" class="form-control" name="mailserver" value="' . $extra['mailserver'] . '">' . "\r\n" . ' </div>' .
       
    "\r\n\r\n\r\n" . '</div>' . "\r\n\r\n" . ' <div class="modal-footer">' . "\r\n" . '  <button type="submit" class="btn btn-primary">Update</button>' . "\r\n" . '  <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>' . "\r\n" . ' </div>' . "\r\n" . ' </form>';
  echo json_encode(["content" => $return, "title" => "Arrange payment method (Method: " . $method["method_name"] . ")"]);


// Ended Easypaisa Code


// JazzCash Code by Muhammad Faisal

elseif ($action == "edit_paymentmethod" && $_POST["id"] == "Jazzcash") :
  $id = $_POST['id'];
    $method = $conn->prepare('SELECT * FROM payment_methods WHERE method_get=:id ');
    $method->execute(['id' => $id]);
    $method = $method->fetch(PDO::FETCH_ASSOC);
    ...
    $return .= '>Inactive</option>' . "\r\n" . '</select>' . "\r\n" . '  </div>' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Visible name</label>' . "\r\n" . '  <input type="text" class="form-control" name="name" value="' . $extra['name'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Minimum Payment</label>' . "\r\n" . '  <input type="text" class="form-control" name="min" value="' . $extra['min'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Maximum Payment</label>' . "\r\n" . '  <input type="text" class="form-control" name="max" value="' . $extra['max'] . '">' . "\r\n" .  ' <hr>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">JazzCash Account Number</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_number" value="' . $extra['account_number'] . '">' . "\r\n" . ' </div>' . "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Account Title</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_name" value="' . $extra['account_name'] . '">' . "\r\n" . ' </div>' . "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Transaction Fee %</label>' . "\r\n" . '  <input type="text" class="form-control" name="tnx_fee" value="' . $extra['tnx_fee'] . '">' . "\r\n" . ' </div>' .  "\r\n" . 
     '<div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Instructions</label>' . "\r\n" . '  <input type="text" class="form-control" name="instructions" value="' . $extra['instructions'] . '">'
...
// Ended JazzCash Code by Muhammad Faisal


// Start Nayapay Code

elseif ($action == "edit_paymentmethod" && $_POST["id"] == "Nayapay") :
  $id = $_POST['id'];
    $method = $conn->prepare('SELECT * FROM payment_methods WHERE method_get=:id ');
    $method->execute(['id' => $id]);
    $method = $method->fetch(PDO::FETCH_ASSOC);
    ...
    $return .= '>Inactive</option>' . "\r\n" . '</select>' . "\r\n" . '  </div>' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Visible name</label>' . "\r\n" . '  <input type="text" class="form-control" name="name" value="' . $extra['name'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Minimum Payment</label>' . "\r\n" . '  <input type="number" class="form-control" name="min" value="' . $extra['min'] . '">' . "\r\n" . ' </div>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Maximum Payment</label>' . "\r\n" . '  <input type="number" class="form-control" name="max" value="' . $extra['max'] . '">' . "\r\n" .  ' <hr>' . "\r\n\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Nayapay Account Number</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_number" value="' . $extra['account_number'] . '">' . "\r\n" . ' </div>' . "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Account Title</label>' . "\r\n" . '  <input type="text" class="form-control" name="account_name" value="' . $extra['account_name'] . '">' . "\r\n" . ' </div>' .
     "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">IBAN</label>' . "\r\n" . '  <input type="text" class="form-control" name="iban" value="' . $extra['iban'] . '">' . "\r\n" . ' </div>' .
    "\r\n" . ' <div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Transaction Fee %</label>' . "\r\n" . '  <input type="text" class="form-control" name="tnx_fee" value="' . $extra['tnx_fee'] . '">' . "\r\n" . ' </div>' .  "\r\n" . 
     '<div class="form-group">' . "\r\n" . '  <label class="form-group__service-name">Instructions</label>' . "\r\n" . '  <input type="text" class="form-control" name="instructions" value="' . $extra['instructions'] . '">'
